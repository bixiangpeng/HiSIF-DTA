...
echo "********************************************************"
echo "The testing of the model's performance on the DTA task is about to commence. Waiting...."
wait
echo "********************************************************"
echo "Test the performance of the Bottom-Up model on the davis dataset"
python testing_for_DTA.py --model BUNet --dataset davis
wait
echo "********************************************************"
echo "Test the performance of the Top-Down model on the davis dataset"
python testing_for_DTA.py --model TDNet --dataset davis
wait
echo "********************************************************"
echo "Test the performance of the Bottom-Up model on the kiba dataset"
python testing_for_DTA.py --model BUNet --dataset kiba
wait
echo "********************************************************"
echo "Test the performance of the Top-Down model on the kiba dataset"
python testing_for_DTA.py --model TDNet --dataset kiba
wait
echo "********************************************************"
echo "\n"

echo "********************************************************"
echo "The testing of the model's performance on the CPI task is about to commence. Waiting...."
wait
echo "********************************************************"
...
python testing_for_CPI.py --model TDNet --dataset Human
wait
echo "********************************************************"
echo "\n"
...
python testing_for_Ablation.py --model LSM --dataset davis
wait
echo "********************************************************"
echo "Test the performance of the HSM variant model on the davis dataset"
python testing_for_Ablation.py --model HSM --dataset davis
wait
echo "********************************************************"
echo "Test the performance of the HFS variant model on the davis dataset"
python testing_for_Ablation.py --model HFS --dataset davis
wait
echo "********************************************************"
echo "\n"
