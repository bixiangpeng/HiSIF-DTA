...
class HSM(nn.Module): #Ablation variant architecture which removes the PPI module from the original one.
...
class HFS(nn.Module): #Ablation variant architecture that removes the feature fusion module from the original one and replaces it with concatenation.
    def __init__(self, n_output=1, output_dim=128, num_features_xd=78, num_features_pro=33,num_features_ppi = 1442):
...
class LSM(nn.Module):# Ablation variant architecture that removes the protein graph module from the original one
    def __init__(self, n_output=1, output_dim=128, num_features_xd=78, num_features_pro=33,num_features_ppi = 1442):
